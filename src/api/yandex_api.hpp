#ifndef YANDEX_API_HPP
#define YANDEX_API_HPP
...
class YandexAPI : public BaseAPI {
public:
    YandexAPI(
    ...
    std::string init_upload_file_yandex(const std::string &file_path) override;
...
private:
    ...
    const std::string AUTH_URL = "https://oauth.yandex.ru/authorize";
    const std::string TOKEN_URL = "https://oauth.yandex.ru/token";
};

#endif // YANDEX_API_HPP